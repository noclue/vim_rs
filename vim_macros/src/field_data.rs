...
static CLASS_FIELDS: phf::Map<&'static str, phf::Map<&'static str, NodeData>> = ::phf::Map {
    ...
    entries: &[
        ("p_mem_admission_control_enabled", NodeData { type_decl: "bool", type_name: "", is_optional: true, processing_type: FieldProcessingType::Enum("PrimitiveBoolean"), path_segment: "pMemAdmissionControlEnabled", doc: Some(r#####"Flag that determines whether strict admission control for persistent
memory is enabled.
...
"#####) },),
    ...
    entries: &[
        ("max_sev_es_guests", NodeData { type_decl: "i64", type_name: "", is_optional: false, processing_type: FieldProcessingType::Enum("PrimitiveLong"), path_segment: "maxSevEsGuests", doc: Some(r#####"The maximum number of SEV-ES guests supported on this host.
"#####) },),
...
"#####) },),
    ...
    entries: &[
        ("opaque_network_type", NodeData { type_decl: "String", type_name: "", is_optional: false, processing_type: FieldProcessingType::Enum("PrimitiveString"), path_segment: "opaqueNetworkType", doc: Some(r#####"Type of the Opaque network to which the virtual NIC is connected.
"#####) },),
        ("opaque_network_id", NodeData { type_decl: "String", type_name: "", is_optional: false, processing_type: FieldProcessingType::Enum("PrimitiveString"), path_segment: "opaqueNetworkId", doc: Some(r#####"ID of the Opaque network to which the virtual NIC is connected.
"#####) },),
    ],
}),
...
virtual machines.
"#####) },),
        ("vcs_slots", NodeData { type_decl: "Vec<vim_rs::types::structs::ClusterComputeResourceVcsSlots>", type_name: "", is_optional: true, processing_type: FieldProcessingType::Enum("ArrayOfClusterComputeResourceVcsSlots"), path_segment: "vcsSlots", doc: Some(r#####"An array of hosts and number of resource slots on the host for
...
"#####) },),
        ("vcs_health_status", NodeData { type_decl: "String", type_name: "", is_optional: true, processing_type: FieldProcessingType::Enum("PrimitiveString"), path_segment: "vcsHealthStatus", doc: Some(r#####"The health status of the vSphere Cluster Services in the cluster.
...
"#####) },),
    ...
    entries: &[
        ("portgroup_key", NodeData { type_decl: "String", type_name: "", is_optional: true, processing_type: FieldProcessingType::Enum("PrimitiveString"), path_segment: "portgroupKey", doc: Some(r#####"Key of the portgroup.
...
"#####) },),
        ("connection_cookie", NodeData { type_decl: "i32", type_name: "", is_optional: true, processing_type: FieldProcessingType::Enum("PrimitiveInt"), path_segment: "connectionCookie", doc: Some(r#####"Cookie that represents this *DistributedVirtualSwitchPortConnection*
...
"#####) },),
        ("switch_uuid", NodeData { type_decl: "String", type_name: "", is_optional: false, processing_type: FieldProcessingType::Enum("PrimitiveString"), path_segment: "switchUuid", doc: Some(r#####"UUID of the switch (*DistributedVirtualSwitch*.*DistributedVirtualSwitch.uuid*).
"#####) },),
        ("port_key", NodeData { type_decl: "String", type_name: "", is_optional: true, processing_type: FieldProcessingType::Enum("PrimitiveString"), path_segment: "portKey", doc: Some(r#####"Key of the port.
...
"#####) },),
        ("selected_vnic", NodeData { type_decl: "vim_rs::types::structs::HostVirtualNic", type_name: "HostVirtualNic", is_optional: true, processing_type: FieldProcessingType::Struct, path_segment: "selectedVnic", doc: Some(r#####"VirtualNic that is selected for use in VMotion operations.
"#####) },),
    ],
}),
...
"#####) },),
    ...
    entries: &[
        ("spec", NodeData { type_decl: "vim_rs::types::structs::HostVirtualNicSpec", type_name: "HostVirtualNicSpec", is_optional: false, processing_type: FieldProcessingType::Struct, path_segment: "spec", doc: Some(r#####"Configurable properties for the virtual network adapter object.
"#####) },),
        ("key", NodeData { type_decl: "String", type_name: "", is_optional: false, processing_type: FieldProcessingType::Enum("PrimitiveString"), path_segment: "key", doc: Some(r#####"Linkable identifier.
"#####) },),
        ("device", NodeData { type_decl: "String", type_name: "", is_optional: false, processing_type: FieldProcessingType::Enum("PrimitiveString"), path_segment: "device", doc: Some(r#####"Device name.
"#####) },),
        ("port", NodeData { type_decl: "vim_rs::types::structs::HostPortGroupPort", type_name: "HostPortGroupPort", is_optional: true, processing_type: FieldProcessingType::Struct, path_segment: "port", doc: Some(r#####"Port(*HostPortGroup.port*) on the port group that the virtual
...
"#####) },),
        ("portgroup", NodeData { type_decl: "String", type_name: "", is_optional: false, processing_type: FieldProcessingType::Enum("PrimitiveString"), path_segment: "portgroup", doc: Some(r#####"If the Virtual NIC is connecting to a vSwitch, this property is the name of
portgroup connected.
...
"#####) },),
        ("version", NodeData { type_decl: "String", type_name: "", is_optional: false, processing_type: FieldProcessingType::Enum("PrimitiveString"), path_segment: "version", doc: Some(r#####"Dot-separated version string.
...
"#####) },),
        ("api_version", NodeData { type_decl: "String", type_name: "", is_optional: false, processing_type: FieldProcessingType::Enum("PrimitiveString"), path_segment: "apiVersion", doc: Some(r#####"The version of the API as a dot-separated string.
...
"#####) },),
    ...
    entries: &[
        ("external_id", NodeData { type_decl: "String", type_name: "", is_optional: true, processing_type: FieldProcessingType::Enum("PrimitiveString"), path_segment: "externalId", doc: Some(r#####"An ID assigned to the vmkernel adapter by external management plane.
...
"#####) },),
        ("dpu_id", NodeData { type_decl: "String", type_name: "", is_optional: true, processing_type: FieldProcessingType::Enum("PrimitiveString"), path_segment: "dpuId", doc: Some(r#####"The identifier of the DPU hosting the vmknic.

If vmknic is on ESX host, dpuId will be unset.

***Since:*** vSphere API Release 8.0.0.1
"#####) },),
        ("ip", NodeData { type_decl: "vim_rs::types::structs::HostIpConfig", type_name: "HostIpConfig", is_optional: true, processing_type: FieldProcessingType::Struct, path_segment: "ip", doc: Some(r#####"IP configuration on the virtual network adapter.
"#####) },),
        ("system_owned", NodeData { type_decl: "bool", type_name: "", is_optional: true, processing_type: FieldProcessingType::Enum("PrimitiveBoolean"), path_segment: "systemOwned", doc: Some(r#####"Set to true when the vmkernel adapter is configured by
other system indirectly other than by the user directly.
"#####) },),
        ("portgroup", NodeData { type_decl: "String", type_name: "", is_optional: true, processing_type: FieldProcessingType::Enum("PrimitiveString"), path_segment: "portgroup", doc: Some(r#####"Portgroup (*HostPortGroup*) to which the virtual NIC is connected.
...
"#####) },),
        ("distributed_virtual_port", NodeData { type_decl: "vim_rs::types::structs::DistributedVirtualSwitchPortConnection", type_name: "DistributedVirtualSwitchPortConnection", is_optional: true, processing_type: FieldProcessingType::Struct, path_segment: "distributedVirtualPort", doc: Some(r#####"*DistributedVirtualPort* or *DistributedVirtualPortgroup*
connection.
...
*HostVirtualNicSpec.opaqueNetwork*
"#####) },),
        ("mtu", NodeData { type_decl: "i32", type_name: "", is_optional: true, processing_type: FieldProcessingType::Enum("PrimitiveInt"), path_segment: "mtu", doc: Some(r#####"Maximum transmission unit for packets size in bytes for the virtual
NIC.

If not specified, the Server will use the system default value.
"#####) },),
        ("mac", NodeData { type_decl: "String", type_name: "", is_optional: true, processing_type: FieldProcessingType::Enum("PrimitiveString"), path_segment: "mac", doc: Some(r#####"Media access control (MAC) address of the virtual network adapter.
"#####) },),
        ("opaque_network", NodeData { type_decl: "vim_rs::types::structs::HostVirtualNicOpaqueNetworkSpec", type_name: "HostVirtualNicOpaqueNetworkSpec", is_optional: true, processing_type: FieldProcessingType::Struct, path_segment: "opaqueNetwork", doc: Some(r#####"Opaque network (*HostOpaqueNetworkInfo*) to which the
...
"#####) },),
        ("dynamic_property", NodeData { type_decl: "Vec<vim_rs::types::structs::DynamicProperty>", type_name: "", is_optional: true, processing_type: FieldProcessingType::Enum("ArrayOfDynamicProperty"), path_segment: "dynamicProperty", doc: Some(r#####"Set of dynamic properties.
...
"#####) },),
        ("pinned_pnic", NodeData { type_decl: "String", type_name: "", is_optional: true, processing_type: FieldProcessingType::Enum("PrimitiveString"), path_segment: "pinnedPnic", doc: Some(r#####"The physical nic to which the vmkernel adapter is pinned.
...
"#####) },),
        ("ip_route_spec", NodeData { type_decl: "vim_rs::types::structs::HostVirtualNicIpRouteSpec", type_name: "HostVirtualNicIpRouteSpec", is_optional: true, processing_type: FieldProcessingType::Struct, path_segment: "ipRouteSpec", doc: Some(r#####"The ip route configuration used by the vmkernel adapter.

This attribute
allows the vmkernel adapter to specify its own default gateway.
"#####) },),
        ("net_stack_instance_key", NodeData { type_decl: "String", type_name: "", is_optional: true, processing_type: FieldProcessingType::Enum("PrimitiveString"), path_segment: "netStackInstanceKey", doc: Some(r#####"The NetStackInstance that the virtual NIC uses, the value of this property
is default to be *defaultTcpipStack*
"#####) },),
        ("tso_enabled", NodeData { type_decl: "bool", type_name: "", is_optional: true, processing_type: FieldProcessingType::Enum("PrimitiveBoolean"), path_segment: "tsoEnabled", doc: Some(r#####"Flag enabling or disabling TCP segmentation offset for a virtual NIC.
...
"#####) },),
    ...
    entries: &[
        ("host_default_graphics_type", NodeData { type_decl: "String", type_name: "", is_optional: false, processing_type: FieldProcessingType::Enum("PrimitiveString"), path_segment: "hostDefaultGraphicsType", doc: Some(r#####"The host default graphics type (@see GraphicsType).
...
device (see @SharedPassthruAssignmentPolicy).
"#####) },),
...
"#####) },),
    ...
    entries: &[
        ("io_load_balance_automation_mode", NodeData { type_decl: "String", type_name: "", is_optional: true, processing_type: FieldProcessingType::Enum("PrimitiveString"), path_segment: "ioLoadBalanceAutomationMode", doc: Some(r#####"Specifies the behavior of Storage DRS when it generates
...
"#####) },),
        ("remote_certificate_thumbprint", NodeData { type_decl: "String", type_name: "", is_optional: true, processing_type: FieldProcessingType::Enum("PrimitiveString"), path_segment: "remoteCertificateThumbprint", doc: Some(r#####"The SHA256 thumbprint of the remote server certificate.
...
"#####) },),
    ...
    entries: &[
        ("ip_route_config", NodeData { type_decl: "Box<dyn vim_rs::types::traits::HostIpRouteConfigTrait>", type_name: "HostIpRouteConfig", is_optional: true, processing_type: FieldProcessingType::Trait, path_segment: "ipRouteConfig", doc: Some(r#####"By default, a host virtual NIC uses default gateway configuration
...
"#####) },),
        ("storage_iorm_supported", NodeData { type_decl: "bool", type_name: "", is_optional: false, processing_type: FieldProcessingType::Enum("PrimitiveBoolean"), path_segment: "storageIORMSupported", doc: Some(r#####"Indicates whether the datastore supports Storage I/O Resource Management.
"#####) },),
...
"#####) },),
        ("available_p_mem_capacity", NodeData { type_decl: "i32", type_name: "", is_optional: true, processing_type: FieldProcessingType::Enum("PrimitiveInt"), path_segment: "availablePMemCapacity", doc: Some(r#####"The available capacity in MB.
"#####) },),
...
"#####) },),
        ("pmem_failover_supported", NodeData { type_decl: "bool", type_name: "", is_optional: true, processing_type: FieldProcessingType::Enum("PrimitiveBoolean"), path_segment: "pmemFailoverSupported", doc: Some(r#####"Indicates support for failover to a dfferent host on VM's with pmem.
...
"#####) },),
        ("vsan_host_config", NodeData { type_decl: "vim_rs::types::structs::VsanHostConfigInfo", type_name: "VsanHostConfigInfo", is_optional: true, processing_type: FieldProcessingType::Struct, path_segment: "vsanHostConfig", doc: Some(r#####"VSAN configuration for a host.
"#####) },),
...
"#####) },),
    ...
    entries: &[
        ("reservable_iops_threshold", NodeData { type_decl: "i32", type_name: "", is_optional: true, processing_type: FieldProcessingType::Enum("PrimitiveInt"), path_segment: "reservableIopsThreshold", doc: Some(r#####"Storage DRS makes storage migration recommendations
...
"#####) },),
        ("reservation_enabled", NodeData { type_decl: "bool", type_name: "", is_optional: false, processing_type: FieldProcessingType::Enum("PrimitiveBoolean"), path_segment: "reservationEnabled", doc: Some(r#####"Flag indicating whether IO reservations support is enabled.
"#####) },),
...
"#####) },),
    ...
    entries: &[
        ("mac", NodeData { type_decl: "Vec<String>", type_name: "", is_optional: true, processing_type: FieldProcessingType::Enum("ArrayOfString"), path_segment: "mac", doc: Some(r#####"The Media Access Control (MAC) address of network service of
the virtual machine connected on this port.
"#####) },),
        ("r#type", NodeData { type_decl: "String", type_name: "", is_optional: false, processing_type: FieldProcessingType::Enum("PrimitiveString"), path_segment: "type", doc: Some(r#####"The type of component connected on this port.

Must be one of the
values of *PortGroupConnecteeType_enum*.
"#####) },),
        ("key", NodeData { type_decl: "String", type_name: "", is_optional: true, processing_type: FieldProcessingType::Enum("PrimitiveString"), path_segment: "key", doc: Some(r#####"The linkable identifier.
"#####) },),
    ],
}),
...
"#####) },),
        ("ip_config", NodeData { type_decl: "vim_rs::types::structs::HostIpConfig", type_name: "HostIpConfig", is_optional: true, processing_type: FieldProcessingType::Struct, path_segment: "ipConfig", doc: Some(r#####"IP configuration of the VMotion VirtualNic.
"#####) },),
    ],
}),
...
"#####) },),
        ("io_load_balance_enabled", NodeData { type_decl: "bool", type_name: "", is_optional: false, processing_type: FieldProcessingType::Enum("PrimitiveBoolean"), path_segment: "ioLoadBalanceEnabled", doc: Some(r#####"Flag indicating whether or not storage DRS takes into account storage I/O
...
"#####) },),
        ("io_load_balance_config", NodeData { type_decl: "vim_rs::types::structs::StorageDrsIoLoadBalanceConfig", type_name: "StorageDrsIoLoadBalanceConfig", is_optional: true, processing_type: FieldProcessingType::Struct, path_segment: "ioLoadBalanceConfig", doc: Some(r#####"The configuration settings for load balancing I/O workload.
...
"#####) },),
        ("pmem", NodeData { type_decl: "vim_rs::types::structs::VirtualMachineVirtualPMem", type_name: "VirtualMachineVirtualPMem", is_optional: true, processing_type: FieldProcessingType::Struct, path_segment: "pmem", doc: Some(r#####"Virtual persistent memory info.
...
"#####) },),
        ("pmem_failover_enabled", NodeData { type_decl: "bool", type_name: "", is_optional: true, processing_type: FieldProcessingType::Enum("PrimitiveBoolean"), path_segment: "pmemFailoverEnabled", doc: Some(r#####"Property to indicate PMem HA failover configuration.
...
"#####) },),
    ...
    entries: &[
        ("port", NodeData { type_decl: "Vec<vim_rs::types::structs::VsanHostConfigInfoNetworkInfoPortConfig>", type_name: "", is_optional: true, processing_type: FieldProcessingType::Enum("ArrayOfVsanHostConfigInfoNetworkInfoPortConfig"), path_segment: "port", doc: Some(r#####"Set of PortConfig entries for use by the VSAN service, one per
...
produce any property values as no updates are generated.
"#####) },),
        ("iorm_configuration", NodeData { type_decl: "vim_rs::types::structs::StorageIormInfo", type_name: "StorageIORMInfo", is_optional: true, processing_type: FieldProcessingType::Struct, path_segment: "iormConfiguration", doc: Some(r#####"Configuration of storage I/O resource management for the datastore.
...
VMFS datastores.
"#####) },),
        ("p_mem_snapshot_supported", NodeData { type_decl: "bool", type_name: "", is_optional: true, processing_type: FieldProcessingType::Enum("PrimitiveBoolean"), path_segment: "pMemSnapshotSupported", doc: Some(r#####"Indicates whether this host supports snapshots for VMs with virtual
...
"#####) },),
        ("p_mem_failover_supported", NodeData { type_decl: "bool", type_name: "", is_optional: true, processing_type: FieldProcessingType::Enum("PrimitiveBoolean"), path_segment: "pMemFailoverSupported", doc: Some(r#####"Indicates whether this host supports failover for VMs with virtual
devices backed by persistent memory.
...
"#####) },),
        ("storage_iorm_supported", NodeData { type_decl: "bool", type_name: "", is_optional: false, processing_type: FieldProcessingType::Enum("PrimitiveBoolean"), path_segment: "storageIORMSupported", doc: Some(r#####"Indicates whether the host supports storage I/O resource
management.
"#####) },),
...
version.
"#####) },),
        ("p_mem_supported", NodeData { type_decl: "bool", type_name: "", is_optional: true, processing_type: FieldProcessingType::Enum("PrimitiveBoolean"), path_segment: "pMemSupported", doc: Some(r#####"Indicates whether this host supports persistent memory.
...
"#####) },),
        ("p_mem_independent_snapshot_supported", NodeData { type_decl: "bool", type_name: "", is_optional: true, processing_type: FieldProcessingType::Enum("PrimitiveBoolean"), path_segment: "pMemIndependentSnapshotSupported", doc: Some(r#####"Indicates whether this host supports snapshots of VMs configured
...
"#####) },),
        ("smart_card_authentication_supported", NodeData { type_decl: "bool", type_name: "", is_optional: true, processing_type: FieldProcessingType::Enum("PrimitiveBoolean"), path_segment: "smartCardAuthenticationSupported", doc: Some(r#####"Indicates whether this host supports local two-factor user
