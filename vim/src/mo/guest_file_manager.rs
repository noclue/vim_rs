...
use crate::types::structs::GuestFileAttributesTrait;
...
impl GuestFileManager {
    ...
    pub async fn change_file_attributes_in_guest(&self, vm: &ManagedObjectReference, auth: &dyn GuestAuthenticationTrait, guest_file_path: &str, file_attributes: &dyn GuestFileAttributesTrait) -> Result<()> {
    ...
    pub async fn create_temporary_directory_in_guest(&self, vm: &ManagedObjectReference, auth: &dyn GuestAuthenticationTrait, prefix: &str, suffix: &str, directory_path: Option<&str>) -> Result<String> {
    ...
    /// ***OperationDisabledByGuest***: if the operation is not enabled due to
    /// guest agent configuration.
    pub async fn create_temporary_file_in_guest(&self, vm: &ManagedObjectReference, auth: &dyn GuestAuthenticationTrait, prefix: &str, suffix: &str, directory_path: Option<&str>) -> Result<String> {
    ...
    /// ***OperationDisabledByGuest***: if the operation is not enabled due to
    /// guest agent configuration.
    pub async fn delete_directory_in_guest(&self, vm: &ManagedObjectReference, auth: &dyn GuestAuthenticationTrait, directory_path: &str, recursive: bool) -> Result<()> {
    ...
    /// ***OperationDisabledByGuest***: if the operation is not enabled due to
    /// guest agent configuration.
    pub async fn delete_file_in_guest(&self, vm: &ManagedObjectReference, auth: &dyn GuestAuthenticationTrait, file_path: &str) -> Result<()> {
    ...
    /// ***OperationDisabledByGuest***: If the operation is not enabled due
    /// to guest agent configuration.
    pub async fn initiate_file_transfer_from_guest(&self, vm: &ManagedObjectReference, auth: &dyn GuestAuthenticationTrait, guest_file_path: &str) -> Result<FileTransferInformation> {
    ...
    /// ***OperationDisabledByGuest***: If the operation is not enabled due to
    /// guest agent configuration.
    pub async fn initiate_file_transfer_to_guest(&self, vm: &ManagedObjectReference, auth: &dyn GuestAuthenticationTrait, guest_file_path: &str, file_attributes: &dyn GuestFileAttributesTrait, file_size: i64, overwrite: bool) -> Result<String> {
    ...
    /// ***OperationDisabledByGuest***: if the operation is not enabled due to
    /// guest agent configuration.
    pub async fn list_files_in_guest(&self, vm: &ManagedObjectReference, auth: &dyn GuestAuthenticationTrait, file_path: &str, index: Option<i32>, max_results: Option<i32>, match_pattern: Option<&str>) -> Result<GuestListFileInfo> {
    ...
    /// ***OperationDisabledByGuest***: if the operation is not enabled due to
    /// guest agent configuration.
    pub async fn make_directory_in_guest(&self, vm: &ManagedObjectReference, auth: &dyn GuestAuthenticationTrait, directory_path: &str, create_parent_directories: bool) -> Result<()> {
    ...
    /// ***OperationDisabledByGuest***: if the operation is not enabled due to
    /// guest agent configuration.
    pub async fn move_directory_in_guest(&self, vm: &ManagedObjectReference, auth: &dyn GuestAuthenticationTrait, src_directory_path: &str, dst_directory_path: &str) -> Result<()> {
    ...
    /// ***OperationDisabledByGuest***: if the operation is not enabled due to
    /// guest agent configuration.
    pub async fn move_file_in_guest(&self, vm: &ManagedObjectReference, auth: &dyn GuestAuthenticationTrait, src_file_path: &str, dst_file_path: &str, overwrite: bool) -> Result<()> {
...
struct ChangeFileAttributesInGuestRequestType<'a> {
    ...
    file_attributes: &'a dyn GuestFileAttributesTrait,
}
#[derive(serde::Serialize)]
#[serde(tag="_typeName")]
