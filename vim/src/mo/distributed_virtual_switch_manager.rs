...
use crate::types::structs::DistributedVirtualSwitchManagerHostDvsFilterSpecTrait;
...
use crate::types::structs::DvsFeatureCapabilityTrait;
...
use crate::types::structs::SelectionSetTrait;
...
struct QueryDvsCheckCompatibilityRequestType<'a> {
    ...
    host_filter_spec: Option<&'a [Box<dyn DistributedVirtualSwitchManagerHostDvsFilterSpecTrait>]>,
}
#[derive(serde::Serialize)]
...
struct DvsManagerExportEntityRequestType<'a> {
    ...
    selection_set: &'a [Box<dyn SelectionSetTrait>],
}
#[derive(serde::Serialize)]
