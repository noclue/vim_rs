...
impl EventHistoryCollector {
    ...
    pub async fn read_next_events(&self, max_count: i32) -> Result<Option<Vec<Box<dyn EventTrait>>>> {
    ...
    /// ### max_count
    /// The maximum number of items in the page.
    pub async fn read_previous_events(&self, max_count: i32) -> Result<Option<Vec<Box<dyn EventTrait>>>> {
    ...
    pub async fn latest_page(&self) -> Result<Option<Vec<Box<dyn EventTrait>>>> {
