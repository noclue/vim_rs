...
use crate::types::enums::HttpNfcLeaseStateEnum;
...
impl HttpNfcLease {
    ...
    pub async fn http_nfc_lease_abort(&self, fault: Option<&dyn MethodFaultTrait>) -> Result<()> {
    ...
    pub async fn state(&self) -> Result<HttpNfcLeaseStateEnum> {
...
struct HttpNfcLeaseAbortRequestType<'a> {
    ...
    fault: Option<&'a dyn MethodFaultTrait>,
}
#[derive(serde::Serialize)]
#[serde(tag="_typeName")]
