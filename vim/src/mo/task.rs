...
use crate::types::enums::TaskInfoStateEnum;
...
impl Task {
    ...
    pub async fn set_task_state(&self, state: TaskInfoStateEnum, result: Option<VimAny>, fault: Option<&dyn MethodFaultTrait>) -> Result<()> {
