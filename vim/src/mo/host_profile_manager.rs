...
use crate::types::structs::ProfileCreateSpecTrait;
...
struct UpdateAnswerFileRequestType<'a> {
    host: &'a ManagedObjectReference,
    #[serde(rename = "configSpec")]
    config_spec: &'a dyn AnswerFileCreateSpecTrait,
}
#[derive(serde::Serialize)]
#[serde(tag="_typeName")]
