...
use crate::types::structs::PerfEntityMetricBaseTrait;
...
impl PerformanceManager {
    ...
    pub async fn query_perf(&self, query_spec: &[PerfQuerySpec]) -> Result<Option<Vec<Box<dyn PerfEntityMetricBaseTrait>>>> {
