...
use crate::types::structs::CryptoSpecTrait;
...
use crate::types::structs::VirtualMachineProfileSpecTrait;
...
impl VcenterVStorageObjectManager {
    ...
    /// 
    /// ***NotFound***: If specified virtual storage object cannot be found.
    pub async fn create_disk_from_snapshot_task(&self, id: &Id, datastore: &ManagedObjectReference, snapshot_id: &Id, name: &str, profile: Option<&[Box<dyn VirtualMachineProfileSpecTrait>]>, crypto: Option<&dyn CryptoSpecTrait>, path: Option<&str>) -> Result<ManagedObjectReference> {
    ...
    /// 
    /// ***TaskInProgress***: If the virtual storage object is busy.
    pub async fn update_v_storage_object_crypto_task(&self, id: &Id, datastore: &ManagedObjectReference, profile: Option<&[Box<dyn VirtualMachineProfileSpecTrait>]>, disks_crypto: Option<&DiskCryptoSpec>) -> Result<ManagedObjectReference> {
    ...
    /// 
    /// ***TaskInProgress***: If the virtual storage object is busy.
    pub async fn update_v_storage_object_policy_task(&self, id: &Id, datastore: &ManagedObjectReference, profile: Option<&[Box<dyn VirtualMachineProfileSpecTrait>]>) -> Result<ManagedObjectReference> {
...
struct CreateDiskFromSnapshotRequestType<'a> {
    ...
    #[serde(default, skip_serializing_if = "Option::is_none")]
    crypto: Option<&'a dyn CryptoSpecTrait>,
    #[serde(default, skip_serializing_if = "Option::is_none")]
    path: Option<&'a str>,
}
#[derive(serde::Serialize)]
