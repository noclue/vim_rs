...
use crate::types::structs::ClusterProfileConfigSpecTrait;
use crate::types::structs::ManagedObjectReference;
use crate::types::structs::ProfileConfigInfoTrait;
...
impl ClusterProfile {
    ...
    pub async fn update_cluster_profile(&self, config: &dyn ClusterProfileConfigSpecTrait) -> Result<()> {
...
struct UpdateClusterProfileRequestType<'a> {
    config: &'a dyn ClusterProfileConfigSpecTrait,
}
