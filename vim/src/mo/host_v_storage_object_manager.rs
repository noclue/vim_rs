...
impl HostVStorageObjectManager {
    ...
    /// 
    /// ***NotFound***: If specified virtual storage object cannot be found.
    pub async fn host_v_storage_object_create_disk_from_snapshot_task(&self, id: &Id, datastore: &ManagedObjectReference, snapshot_id: &Id, name: &str, profile: Option<&[Box<dyn VirtualMachineProfileSpecTrait>]>, crypto: Option<&dyn CryptoSpecTrait>, path: Option<&str>, provisioning_type: Option<&str>) -> Result<ManagedObjectReference> {
