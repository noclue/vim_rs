...
use crate::types::FcoeConfigFcoeSpecification;
use crate::types::HostDiskPartitionBlockRange;
use crate::types::HostDiskPartitionInfo;
use crate::types::HostDiskPartitionLayout;
use crate::types::HostDiskPartitionSpec;
use crate::types::HostFileSystemVolumeInfo;
use crate::types::HostHbaCreateSpecTrait;
use crate::types::HostInternetScsiHbaAuthenticationProperties;
use crate::types::HostInternetScsiHbaDigestProperties;
use crate::types::HostInternetScsiHbaDiscoveryProperties;
use crate::types::HostInternetScsiHbaIpProperties;
use crate::types::HostInternetScsiHbaParamValue;
use crate::types::HostInternetScsiHbaSendTarget;
use crate::types::HostInternetScsiHbaStaticTarget;
use crate::types::HostInternetScsiHbaTargetSet;
use crate::types::HostMultipathInfoHppLogicalUnitPolicy;
use crate::types::HostMultipathInfoLogicalUnitPolicyTrait;
use crate::types::HostMultipathStateInfo;
use crate::types::HostNasVolumeUserInfo;
use crate::types::HostNvmeConnectSpec;
use crate::types::HostNvmeDisconnectSpec;
use crate::types::HostNvmeDiscoverSpec;
use crate::types::HostNvmeDiscoveryLog;
use crate::types::HostPathSelectionPolicyOption;
use crate::types::HostScsiDisk;
use crate::types::HostScsiDiskPartition;
use crate::types::HostStorageArrayTypePolicyOption;
use crate::types::HostStorageDeviceInfo;
use crate::types::HostUnresolvedVmfsResolutionResult;
use crate::types::HostUnresolvedVmfsResolutionSpec;
use crate::types::HostUnresolvedVmfsVolume;
use crate::types::HostVffsSpec;
use crate::types::HostVffsVolume;
use crate::types::HostVmfsSpec;
use crate::types::HostVmfsVolume;
use crate::types::ManagedObjectReference;
use crate::types::VmfsConfigOption;
use crate::types::VmfsUnmapBandwidthSpec;
...
impl HostStorageSystem {
    ...
    /// 
    /// ***HostConfigFault***: if the host is unable to create the adapter.
    pub async fn create_software_adapter(&self, spec: &dyn HostHbaCreateSpecTrait) -> Result<()> {
    ...
    /// 
    /// ***HostConfigFault***: for all other configuration failures.
    pub async fn set_multipath_lun_policy(&self, lun_id: &str, policy: &dyn HostMultipathInfoLogicalUnitPolicyTrait) -> Result<()> {
...
struct CreateSoftwareAdapterRequestType<'a> {
    spec: &'a dyn HostHbaCreateSpecTrait,
}
#[derive(serde::Serialize)]
#[serde(tag="_typeName")]
...
struct SetMultipathLunPolicyRequestType<'a> {
    #[serde(rename = "lunId")]
    lun_id: &'a str,
    policy: &'a dyn HostMultipathInfoLogicalUnitPolicyTrait,
}
#[derive(serde::Serialize)]
