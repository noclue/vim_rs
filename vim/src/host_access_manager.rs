...
use crate::types::HostAccessControlEntry;
use crate::types::HostAccessModeEnum;
use crate::types::HostLockdownModeEnum;
...
impl HostAccessManager {
    ...
    pub async fn change_access_mode(&self, principal: &str, is_group: bool, access_mode: HostAccessModeEnum) -> Result<()> {
    ...
    pub async fn change_lockdown_mode(&self, mode: HostLockdownModeEnum) -> Result<()> {
    ...
    pub async fn lockdown_mode(&self) -> Result<HostLockdownModeEnum> {
...
struct ChangeAccessModeRequestType<'a> {
    ...
    access_mode: HostAccessModeEnum,
}
#[derive(serde::Serialize)]
#[serde(tag="_typeName")]
