...
use crate::types::ClusterComputeResourceValidationResultBaseTrait;
use crate::types::ClusterHostRecommendation;
use crate::types::SddcBase;
use crate::types::ClusterRuleInfoTrait;
use crate::types::ClusterActionHistory;
use crate::types::ClusterDrsMigration;
use crate::types::ClusterComputeResourceHciConfigSpec;
use crate::types::ClusterEnterMaintenanceResult;
use crate::types::EventTrait;
use crate::types::AlarmState;
use crate::types::CustomFieldValueTrait;
use crate::types::ClusterComputeResourceHciConfigInfo;
use crate::types::ClusterDasAdvancedRuntimeInfoTrait;
use crate::types::OptionValueTrait;
use crate::types::ComputeResourceConfigSpecTrait;
use crate::types::PlacementResult;
use crate::types::CustomFieldDef;
use crate::types::ClusterConfigInfo;
use crate::types::PlacementSpec;
use crate::types::ClusterDrsRecommendation;
use crate::types::Permission;
use crate::types::ManagedEntityStatusEnum;
use crate::types::ComputeResourceConfigInfoTrait;
use crate::types::ClusterDrsFaults;
use crate::types::ClusterRecommendation;
use crate::types::ClusterConfigSpec;
use crate::types::HostConnectSpec;
use crate::types::ClusterComputeResourceHostConfigurationInput;
use crate::types::ClusterResourceUsageSummary;
use crate::types::ComputeResourceSummaryTrait;
use crate::types::ClusterComputeResourceSummary;
use crate::types::Tag;
...
impl ClusterComputeResource {
    ...
    /// be evacuated.
    pub async fn cluster_enter_maintenance_mode(&self, host: &[ManagedObjectReference], option: Option<&[Box<dyn OptionValueTrait>]>) -> Result<ClusterEnterMaintenanceResult> {
    ...
    pub async fn evc_manager(&self) -> Result<ManagedObjectReference> {
    ...
    pub async fn find_rules_for_vm(&self, vm: &ManagedObjectReference) -> Result<Option<Vec<Box<dyn ClusterRuleInfoTrait>>>> {
    ...
    /// 
    /// Refers instance of *Task*.
    pub async fn reconfigure_compute_resource_task(&self, spec: &dyn ComputeResourceConfigSpecTrait, modify: bool) -> Result<ManagedObjectReference> {
    ...
    /// 
    /// ***Required privileges:*** System.Read
    pub async fn retrieve_das_advanced_runtime_info(&self) -> Result<Box<dyn ClusterDasAdvancedRuntimeInfoTrait>> {
    ...
    ///
    /// Failure
    pub async fn validate_hci_configuration(&self, hci_config_spec: Option<&ClusterComputeResourceHciConfigSpec>, hosts: Option<&[ManagedObjectReference]>) -> Result<Option<Vec<Box<dyn ClusterComputeResourceValidationResultBaseTrait>>>> {
    ...
    pub async fn configuration_ex(&self) -> Result<Box<dyn ComputeResourceConfigInfoTrait>> {
    ...
    pub async fn hci_config(&self) -> Result<ClusterComputeResourceHciConfigInfo> {
    ...
    pub async fn summary(&self) -> Result<Box<dyn ComputeResourceSummaryTrait>> {
...
struct ReconfigureComputeResourceRequestType<'a> {
    spec: &'a dyn ComputeResourceConfigSpecTrait,
    modify: bool,
}
#[derive(serde::Serialize)]
#[serde(tag="_typeName")]
