...
impl GuestWindowsRegistryManager {
    ...
    pub async fn create_registry_key_in_guest(&self, vm: &ManagedObjectReference, auth: &dyn GuestAuthenticationTrait, key_name: &GuestRegKeyNameSpec, is_volatile: bool, class_type: Option<&str>) -> Result<()> {
    ...
    /// ***OperationDisabledByGuest***: if the operation is not enabled due to
    /// guest agent configuration.
    pub async fn delete_registry_key_in_guest(&self, vm: &ManagedObjectReference, auth: &dyn GuestAuthenticationTrait, key_name: &GuestRegKeyNameSpec, recursive: bool) -> Result<()> {
    ...
    /// ***OperationDisabledByGuest***: if the operation is not enabled due to
    /// guest agent configuration.
    pub async fn delete_registry_value_in_guest(&self, vm: &ManagedObjectReference, auth: &dyn GuestAuthenticationTrait, value_name: &GuestRegValueNameSpec) -> Result<()> {
    ...
    /// ***OperationDisabledByGuest***: if the operation is not enabled due to
    /// guest agent configuration.
    pub async fn list_registry_keys_in_guest(&self, vm: &ManagedObjectReference, auth: &dyn GuestAuthenticationTrait, key_name: &GuestRegKeyNameSpec, recursive: bool, match_pattern: Option<&str>) -> Result<Option<Vec<GuestRegKeyRecordSpec>>> {
    ...
    /// ***OperationDisabledByGuest***: if the operation is not enabled due to
    /// guest agent configuration.
    pub async fn list_registry_values_in_guest(&self, vm: &ManagedObjectReference, auth: &dyn GuestAuthenticationTrait, key_name: &GuestRegKeyNameSpec, expand_strings: bool, match_pattern: Option<&str>) -> Result<Option<Vec<GuestRegValueSpec>>> {
    ...
    /// ***OperationDisabledByGuest***: if the operation is not enabled due to
    /// guest agent configuration.
    pub async fn set_registry_value_in_guest(&self, vm: &ManagedObjectReference, auth: &dyn GuestAuthenticationTrait, value: &GuestRegValueSpec) -> Result<()> {
