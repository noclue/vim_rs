...
use crate::types::HostSystemReconnectSpec;
use crate::types::ApplyHostProfileConfigurationResult;
use crate::types::HostCapability;
use crate::types::HostSystemSwapConfiguration;
use crate::types::HostServiceTicket;
use crate::types::HostHardwareInfo;
use crate::types::ManagedObjectReference;
use crate::types::HostSystemRemediationState;
use crate::types::Permission;
use crate::types::HostIpmiInfo;
use crate::types::CryptoKeyId;
use crate::types::HostSystemComplianceCheckState;
use crate::types::HostConfigInfo;
use crate::types::HostLicensableResourceInfo;
use crate::types::ApplyHostProfileConfigurationSpec;
use crate::types::Tag;
use crate::types::HostSystemResourceInfo;
use crate::types::HostConnectInfo;
use crate::types::CustomFieldValueTrait;
use crate::types::HostRuntimeInfo;
...
use crate::types::HostConfigManager;
use crate::types::HostTpmAttestationReport;
use crate::types::HostFlagInfo;
use crate::types::CustomFieldDef;
use crate::types::HostListSummary;
