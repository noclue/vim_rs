...
pub enum StructType {
    ...
    #[serde(rename = "AgencyVMFolder")]
    #[strum(serialize = "AgencyVMFolder")]
    AgencyVmFolder,
    #[serde(rename = "AgencyVMResourcePool")]
    #[strum(serialize = "AgencyVMResourcePool")]
    ...
    VmWrongResourcePool,
    VmNotDeployed,
    #[serde(rename = "CannotAccessAgentOVF")]
    #[strum(serialize = "CannotAccessAgentOVF")]
    ...
    #[serde(rename = "PersonalityAgentPMIssue")]
    #[strum(serialize = "PersonalityAgentPMIssue")]
    PersonalityAgentPmIssue,
    #[serde(rename = "PersonalityAgentAwaitingPMRemediation")]
    #[strum(serialize = "PersonalityAgentAwaitingPMRemediation")]
    ...
    #[serde(rename = "IntegrityAgencyVUMIssue")]
    #[strum(serialize = "IntegrityAgencyVUMIssue")]
    IntegrityAgencyVumIssue,
    IntegrityAgencyCannotDeleteSoftware,
    IntegrityAgencyCannotStageSoftware,
    #[serde(rename = "IntegrityAgencyVUMUnavailable")]
    #[strum(serialize = "IntegrityAgencyVUMUnavailable")]
    IntegrityAgencyVumUnavailable,
    #[serde(rename = "PersonalityAgencyPMIssue")]
    #[strum(serialize = "PersonalityAgencyPMIssue")]
    ...
    #[serde(rename = "PersonalityAgencyPMUnavailable")]
    #[strum(serialize = "PersonalityAgencyPMUnavailable")]
    ...
    #[serde(rename = "SolutionsVMNetworkMapping")]
    #[strum(serialize = "SolutionsVMNetworkMapping")]
    SolutionsVmNetworkMapping,
    #[serde(rename = "SolutionsVMSource")]
    #[strum(serialize = "SolutionsVMSource")]
    SolutionsVmSource,
    #[serde(rename = "SolutionsUrlVMSource")]
    #[strum(serialize = "SolutionsUrlVMSource")]
    ...
    SmsProviderSpec,
    VasaProviderSpec,
    #[serde(rename = "VASAProviderUpgradeSpec")]
    #[strum(serialize = "VASAProviderUpgradeSpec")]
    ...
    VirtualMachineMoId,
    #[serde(rename = "VirtualMachineUUID")]
    #[strum(serialize = "VirtualMachineUUID")]
    VirtualMachineUuid,
    FailoverParam,
    TestFailoverParam,
    PolicyAssociation,
    ...
    ClusterUsageSummary,
    #[serde(rename = "VimClusterVSANPreferredFaultDomainInfo")]
    #[strum(serialize = "VimClusterVSANPreferredFaultDomainInfo")]
    VimClusterVsanPreferredFaultDomainInfo,
    #[serde(rename = "VimClusterVSANStretchedClusterCapability")]
    #[strum(serialize = "VimClusterVSANStretchedClusterCapability")]
    VimClusterVsanStretchedClusterCapability,
    #[serde(rename = "VimClusterVSANStretchedClusterFaultDomainConfig")]
    #[strum(serialize = "VimClusterVSANStretchedClusterFaultDomainConfig")]
    VimClusterVsanStretchedClusterFaultDomainConfig,
    #[serde(rename = "VSANStretchedClusterHostVirtualApplianceStatus")]
    #[strum(serialize = "VSANStretchedClusterHostVirtualApplianceStatus")]
    VsanStretchedClusterHostVirtualApplianceStatus,
    #[serde(rename = "VimClusterVSANWitnessHostInfo")]
    #[strum(serialize = "VimClusterVSANWitnessHostInfo")]
    ...
    #[serde(rename = "VsanDataDrivenAPIAction")]
    #[strum(serialize = "VsanDataDrivenAPIAction")]
    ...
    #[serde(rename = "VsanIscsiLUNCommonInfo")]
    #[strum(serialize = "VsanIscsiLUNCommonInfo")]
    VsanIscsiLunCommonInfo,
    #[serde(rename = "VsanIscsiLUN")]
    #[strum(serialize = "VsanIscsiLUN")]
    VsanIscsiLun,
    #[serde(rename = "VsanIscsiLUNSpec")]
    #[strum(serialize = "VsanIscsiLUNSpec")]
    VsanIscsiLunSpec,
    ...
    #[serde(rename = "VsanPerfEntityMetricCSV")]
    #[strum(serialize = "VsanPerfEntityMetricCSV")]
    ...
    VsanPerfMemberInfo,
    VsanPerfMetricId,
    #[serde(rename = "VsanPerfMetricSeriesCSV")]
    #[strum(serialize = "VsanPerfMetricSeriesCSV")]
    ...
    #[serde(rename = "CnsNFSAccessControlSpec")]
    #[strum(serialize = "CnsNFSAccessControlSpec")]
    ...
    CnsBaseCreateSpec,
    CnsFileCreateSpec,
    #[serde(rename = "CnsVSANFileCreateSpec")]
    #[strum(serialize = "CnsVSANFileCreateSpec")]
    ...
    CnsSnapshotId,
    CnsVolume,
    #[serde(rename = "CnsVolumeACLConfigureSpec")]
    #[strum(serialize = "CnsVolumeACLConfigureSpec")]
    ...
    EntityBackup,
    EntityBackupConfig,
    #[serde(rename = "DVSFilterSpecConnecteeSpec")]
    #[strum(serialize = "DVSFilterSpecConnecteeSpec")]
    DvsFilterSpecConnecteeSpec,
    #[serde(rename = "DVSFilterSpecPnicConnecteeSpec")]
    #[strum(serialize = "DVSFilterSpecPnicConnecteeSpec")]
    DvsFilterSpecPnicConnecteeSpec,
    #[serde(rename = "DVSFilterSpecVmConnecteeSpec")]
    #[strum(serialize = "DVSFilterSpecVmConnecteeSpec")]
    DvsFilterSpecVmConnecteeSpec,
    #[serde(rename = "DVSFilterSpecVmknicConnecteeSpec")]
    #[strum(serialize = "DVSFilterSpecVmknicConnecteeSpec")]
    DvsFilterSpecVmknicConnecteeSpec,
    #[serde(rename = "DVSFilterSpecVlanSpec")]
    #[strum(serialize = "DVSFilterSpecVlanSpec")]
    DvsFilterSpecVlanSpec,
    #[serde(rename = "DVSFilterSpecPvlanSpec")]
    #[strum(serialize = "DVSFilterSpecPvlanSpec")]
    DvsFilterSpecPvlanSpec,
    #[serde(rename = "DVSFilterSpecTrunkVlanSpec")]
    #[strum(serialize = "DVSFilterSpecTrunkVlanSpec")]
    DvsFilterSpecTrunkVlanSpec,
    #[serde(rename = "DVSFilterSpecVlanIdSpec")]
    #[strum(serialize = "DVSFilterSpecVlanIdSpec")]
    ...
    #[serde(rename = "LACPInfo")]
    #[strum(serialize = "LACPInfo")]
    LacpInfo,
    #[serde(rename = "LAGInfo")]
    #[strum(serialize = "LAGInfo")]
    LagInfo,
    #[serde(rename = "LAGUplinkInfo")]
    #[strum(serialize = "LAGUplinkInfo")]
    LagUplinkInfo,
    HostLicenseSpec,
    ...
    #[serde(rename = "PnicTSOInfo")]
    #[strum(serialize = "PnicTSOInfo")]
    PnicTsoInfo,
    HostPortGroup,
    HostPortGroupConfig,
    HostPortGroupPort,
    ...
    #[serde(rename = "VimHostVSANStretchedClusterHostCapability")]
    #[strum(serialize = "VimHostVSANStretchedClusterHostCapability")]
    ...
    #[serde(rename = "VsanHostEMMSummary")]
    #[strum(serialize = "VsanHostEMMSummary")]
    VsanHostEmmSummary,
    VsanHostFwComponent,
    ...
    VsanVcgDeviceInfo,
    #[serde(rename = "VsanVmdkIOLoadSpec")]
    #[strum(serialize = "VsanVmdkIOLoadSpec")]
    VsanVmdkIoLoadSpec,
    ...
    #[serde(rename = "VSANEntityCompatibilityResult")]
    #[strum(serialize = "VSANEntityCompatibilityResult")]
    ...
    #[serde(rename = "VsanIODiagnosticsFailedCheck")]
    #[strum(serialize = "VsanIODiagnosticsFailedCheck")]
    VsanIoDiagnosticsFailedCheck,
    #[serde(rename = "VsanIODiagnosticsInstance")]
    #[strum(serialize = "VsanIODiagnosticsInstance")]
    VsanIoDiagnosticsInstance,
    #[serde(rename = "VsanIODiagnosticsInstanceEvent")]
    #[strum(serialize = "VsanIODiagnosticsInstanceEvent")]
    VsanIoDiagnosticsInstanceEvent,
    #[serde(rename = "VsanIODiagnosticsInstanceQuerySpec")]
    #[strum(serialize = "VsanIODiagnosticsInstanceQuerySpec")]
    VsanIoDiagnosticsInstanceQuerySpec,
    #[serde(rename = "VsanIODiagnosticsObjectLayout")]
    #[strum(serialize = "VsanIODiagnosticsObjectLayout")]
    VsanIoDiagnosticsObjectLayout,
    #[serde(rename = "VsanIODiagnosticsPrecheckResult")]
    #[strum(serialize = "VsanIODiagnosticsPrecheckResult")]
    VsanIoDiagnosticsPrecheckResult,
    #[serde(rename = "VsanIODiagnosticsStats")]
    #[strum(serialize = "VsanIODiagnosticsStats")]
    VsanIoDiagnosticsStats,
    #[serde(rename = "VsanIODiagnosticsTarget")]
    #[strum(serialize = "VsanIODiagnosticsTarget")]
    VsanIoDiagnosticsTarget,
    #[serde(rename = "VsanIODiagnosticsTargetStats")]
    #[strum(serialize = "VsanIODiagnosticsTargetStats")]
    VsanIoDiagnosticsTargetStats,
    #[serde(rename = "VsanIOLatency")]
    #[strum(serialize = "VsanIOLatency")]
    VsanIoLatency,
    #[serde(rename = "VsanIOLatencyMetrics")]
    #[strum(serialize = "VsanIOLatencyMetrics")]
    ...
    #[serde(rename = "VsanObjectIOStats")]
    #[strum(serialize = "VsanObjectIOStats")]
    VsanObjectIoStats,
    ...
    #[serde(rename = "SSDEnduranceThresholdSpec")]
    #[strum(serialize = "SSDEnduranceThresholdSpec")]
    SsdEnduranceThresholdSpec,
    VsanServerHostUnicastInfo,
    #[serde(rename = "VSANSharedWitnessCompatibilityResult")]
    #[strum(serialize = "VSANSharedWitnessCompatibilityResult")]
    ...
    #[serde(rename = "VsanIOTripAnalyzerConfig")]
    #[strum(serialize = "VsanIOTripAnalyzerConfig")]
    VsanIoTripAnalyzerConfig,
    #[serde(rename = "VsanIOTripAnalyzerRecurrence")]
    #[strum(serialize = "VsanIOTripAnalyzerRecurrence")]
    ...
    #[serde(rename = "VsanXVCClientInfo")]
    #[strum(serialize = "VsanXVCClientInfo")]
    VsanXvcClientInfo,
    #[serde(rename = "VsanXVCDatastoreConfig")]
    #[strum(serialize = "VsanXVCDatastoreConfig")]
    VsanXvcDatastoreConfig,
    #[serde(rename = "VsanXVCDatastoreInfo")]
    #[strum(serialize = "VsanXVCDatastoreInfo")]
    ...
    EamInvalidState,
    #[serde(rename = "EamIOFault")]
    #[strum(serialize = "EamIOFault")]
    EamIoFault,
